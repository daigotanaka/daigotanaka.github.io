...
fn$label(
    "source",
    paste(
        'The R source code produced the analysis and this report is available from <a href="https://github.com/daigotanaka/essays/blame/master/random-forest-k-fold-cross-validation.Rmd">github page</a>',
        sep="")
)
```
...
`r fn$label("source")` for details of the implementation.
