...
the graph more often these days.  You can hover the mouse cursor over Fig. `r
fn()` to reveal the date of the observation.
...
documents. R markdown lets one focus on the data analysis and production of the
