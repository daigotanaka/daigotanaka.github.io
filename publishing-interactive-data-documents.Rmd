...
footnote("nyt")
```
are some of the sophisticated
examples you may be already familiar.
...
Thanks to the recent developments such as
...
rich documents. R markdown lets one focus on the data analysis and production of
