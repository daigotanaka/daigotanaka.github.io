...
twitter_chart$title(text="Daigo's twitter impressions and engagements in 2014")
...
observations of Ozone and temperature to learn about air quality [^airquality].
We can plot temperatures (F) and Ozone level (ppb) on x and y axes, repectively
as in Fig.  `r fn()`. Just by looking at the plot, we gain a little insight on
the relationship between the two measurements.


```{r, echo=FALSE, message=FALSE, comment=NA, results="asis", tidy=FALSE, cache=TRUE, html.cap=fn("Ozone level and temperature")}
# Plot air quality
ozone_temp
```
...
```{r, echo=FALSE, message=FALSE, comment=NA, results="asis", tidy=FALSE, cache=TRUE, html.cap=fn("Ozone level, temperature, and wind speed")}
...
[^airquality]: New York Air Quality Measurements. For health effects of http://www.epa.gov/groundlevelozone/health.html
